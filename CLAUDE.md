...
- **Commit directly on `main`.** This repo does not use feature branches — the
  "if on the default branch, branch first" rule in the global preferences does
  not apply here. Commit to `main` and push it.
